...
def generate_launch_description():
    ...
    params_file_path = os.path.join(get_package_share_directory(
      'mocap_pose_publisher'), 'config', 'mocap4r2_optitrack_driver_params.yaml')
    ...
    ld.add_action(DeclareLaunchArgument('namespace', default_value='j100_0921'))
